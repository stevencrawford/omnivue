export const STORAGE_KEYS = {
  ...
  CINEMATIC_TREE_WIDTH: "omnivue-cinematic-tree-width",
  CINEMATIC_DRAWER_WIDTH: "omnivue-cinematic-drawer-width",
  CINEMATIC_CONSOLE_HEIGHT: "omnivue-cinematic-console-height",
